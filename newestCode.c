...
#define PWMNOMINAL 12000 // was 2500 -> 7500 wordks best at 9000
...
void main(void){ // wallFollow wall following implementation
  ...
  /*if(Bump_Read() != 0xED){ // collision
    ...
    if(TxChannel <= 2){ // 0,1,2 means new data
      ...
      //printf("left distance =%5d mm | center distance =%5d mm | right distance =%5d mm \n\r",LeftDistance, CenterDistance, RightDistance);

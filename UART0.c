...
EUSCI_A0->BRW = 104; // UCBR = baud rate = int(N) = 104 //9600 ->1250
EUSCI_A0->MCTLW &= ~0xFFF1; // clear first and second modulation stage bit
P1->SEL0 |= 0x0C;
P1->SEL1 &= ~0x0C; // configure P1.3 and P1.2 as primary module
EUSCI_A0->CTLW0 &= ~0x0001; // enable the USCI module
EUSCI_A0->IE &= ~0x000F; // disable interrupts (transmit ready, start
}
//------------UART0_InChar------------
